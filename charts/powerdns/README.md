...
| powerdns.postgres.hostname | string | `"postgres.default.svc.cluster.local"` |  |
| powerdns.postgres.port | int | `5432` |  |
| powerdns.postgres.database | string | `"powerdns"` |  |
| powerdns.postgres.password | string | `"password"` |  |
| powerdns.postgres.username | string | `"powerdns"` |  |
